...
const inactiveUri = Asset.fromModule(require('@/assets/svg/tabs/tab-regions.svg')).uri;
const activeUri = Asset.fromModule(require('@/assets/svg/tabs/tab-regions-active.svg')).uri;
